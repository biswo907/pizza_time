...
const LoginModal = ({ setLoginModalWindow, setValidLogin, loginModalWindow, hideMenu, validLogin, getUser }) => {
  ...
  const [formValue, setFormValue] = useState({ email: 'biswo@gmail.com', password: 'Biswo@404' });
        ...
        <section className="modal__content">
          ...
          {loading ?
            ...
            <form onSubmit={handleLogin}>
              ...
              <input disabled onChange={handleValidation} value={formValue.email} name="email" type="text" placeholder="Email" />
              <span className="modal__form__error">{formError.email}</span>
              <input disabled onChange={handleValidation} value={formValue.password} name="password" type="password" autoComplete="true" placeholder="Password" />
